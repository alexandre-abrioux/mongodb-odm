...
class ValidationActionTest extends BaseTest
{
    public function testWrongValueForValidationActionShouldThrowException()
    {
        ...
        $this->expectExceptionMessageRegExp('#^\[Enum Error\] Attribute "value" of @Doctrine\\\\ODM\\\\MongoDB\\\\Mapping\\\\Annotations\\\\ValidationAction declared on class Doctrine\\\\ODM\\\\MongoDB\\\\Tests\\\\Mapping\\\\Annotations\\\\WrongValueForValidationAction accepts? only \[error, warn\], but got wrong\.$#');
